"""
Jetson Xavier için SLAM + Navigasyon Launch Dosyası
Dağıtık yapı için: Controller'lar + SLAM + Nav2 (Gazebo ve RViz2 olmadan)

Bu dosya sadece Jetson'da çalıştırılmalı.
Bilgisayarda Gazebo çalışıyor olmalı.

Kullanım:
ros2 launch my_robot_bringup jetson_slam_navigation.launch.py
"""
...
def generate_launch_description():
    ...
    # 3. SLAM Toolbox (4 saniye sonra - Controller'ların hazır olması için)
    ...
    # 4. Nav2 Navigation Stack (6 saniye sonra - SLAM'ın başlaması için)
